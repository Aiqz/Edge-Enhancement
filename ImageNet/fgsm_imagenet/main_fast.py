...
from lib import *
from models_imagenet import resnet50, resnet50_EE
...
def main():
    ...
    if configs.TRAIN.arch == 'resnet50':
        model = resnet50(pretrained=configs.pretrained)
    elif configs.TRAIN.arch == 'resnet50_EE':
        model = resnet50_EE(pretrained=configs.pretrained, cize=configs.DATA.crop_size, r=configs.DATA.r, w=configs.DATA.w, low=configs.DATA.low, high=configs.DATA.high)
    else:
