...
from utils.core import Add_Square, CannyFilter_step125_1, HighFreqSuppress, CannyFilter, get_gaussian_kernel
import torchvision.models
__all__ = ['ResNet_EE_square', 'resnet18_EE_square', 'resnet34_EE_square', 'resnet50_EE_square', 'resnet101_EE_square', 'resnet152_EE_square']
...
class ResNet_EE_square(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, cize= 224, r=16, w=0.5, with_gf=False, low=60.0, high=120.0, alpha = 0.0, sigma=1,type_canny='CannyFilter', epsilon=0.05, n_queries=5000):
