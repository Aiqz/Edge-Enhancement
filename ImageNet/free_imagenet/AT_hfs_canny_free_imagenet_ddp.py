...
parser.add_argument('--num-steps-2', type=int, default = 50,
                    help='perturb number of steps')
parser.add_argument('--step-size-2', type=float, default = 1.0 / 255,
                    help='perturb step size')
parser.add_argument('--num-steps-3', type=int, default = 100,
                    help='perturb number of steps')
...
parser.add_argument('--w', default= 1 , type=float, help='wight of canny')
...
parser.add_argument('--low', default= 38 , type=float, help='low_threshold of canny')
parser.add_argument('--high', default= 76 , type=float, help='high_threshold of canny')
...
def main():
    ...
    if args.local_rank == 0:
        ...
        print(
            'arch:{},bs:{},lr:{},wd:{},momentum:{},epochs:{}'.format(args.arch, args.batch_size, args.lr,
                                                                     args.weight_decay, args.momentum,
                                                                     args.epochs))
        print('clip-eps:{},fgsm-step:{},n-repeats:{},nGPU:{}'.format(args.clip_eps, args.fgsm_step,
...
def validate(val_loader, model, criterion, print_freq, device, log_dir):
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        # data_adv= PGD(model, args, input, target, args.num_steps_2, args.step_size_2)
        data_adv= PGD(model, args, input, target, args.num_steps_3, args.step_size_3)
