...
class Net2_EE_square(nn.Module):
    def __init__(self, r=8, w=1, with_gf=False, low=60.0, high=120.0, alpha = 0.0, sigma=1, type_canny='CannyFilter', epsilon=0.05, n_queries=5000):
        super(Net2_EE_square, self).__init__()
        ...
        #square
        self.add_square = Add_Square(channels =1, size=28, epsilon=epsilon, n_queries=n_queries)
