...
class PreActResNet_EE(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, dataset="Tiny-ImageNet", cize= 224, r=16, w=0.5, with_gf=False, low=60.0, high=120.0, alpha=0.0, sigma=1):
        super(PreActResNet_EE, self).__init__()
...
def PreActResNet18_EE(dataset="CIFAR10", **kwargs):
    return PreActResNet_EE(PreActBlock, [2, 2, 2, 2], dataset=dataset, **kwargs)


def PreActResNet34_EE(dataset="CIFAR10", **kwargs):
    return PreActResNet_EE(PreActBlock, [3, 4, 6, 3], dataset=dataset, **kwargs)


def PreActResNet50_EE(dataset="CIFAR10", **kwargs):
    return PreActResNet_EE(PreActBottleneck, [3, 4, 6, 3], dataset=dataset, **kwargs)


def PreActResNet101_EE(dataset="CIFAR10", **kwargs):
    return PreActResNet_EE(PreActBottleneck, [3, 4, 23, 3], dataset=dataset, **kwargs)


def PreActResNet152_EE(dataset="CIFAR10", **kwargs):
    return PreActResNet_EE(PreActBottleneck, [3, 8, 36, 3], dataset=dataset, **kwargs)


def test():
    net = PreActResNet18_EE(dataset="Tiny-ImageNet", cize=64, r=16, w=0.5, with_gf=False, low=60.0, high=120.0, alpha=0.0, sigma=1).cuda()
    # print(net)
